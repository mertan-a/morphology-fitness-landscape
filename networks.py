...
if __name__ == '__main__':
    mlp = NeuralNetwork(input_size=400*9, output_size=400)
    print(f'num params: {parameters_to_vector(mlp.parameters()).shape}')
    transformer = TransformerNetwork(robot_bounding_box=[10,10], observation_per_voxel_size=9, embedding_size=64, 
